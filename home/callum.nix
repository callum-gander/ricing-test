...
in
{
  ...
  # ---- Warm-paper radial-gradient wallpaper, generated by Nix ----
  # Editorial "paper": a barely-there warm vignette, a touch lighter in the centre.
  home.file."Pictures/wall.png".source = pkgs.runCommand "paper-wall.png" { } ''
    ${pkgs.imagemagick}/bin/magick -size 2560x1440 radial-gradient:'#f6f3ec'-'#e7e1d3' $out
  '';
